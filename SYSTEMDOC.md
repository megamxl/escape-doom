...
| LP-03 | All runtime errors must be logged and handled with structured error management throughout the system to address both expected and unexpected issues.             |
| LP-04 | User-facing error messages must be descriptive, enabling users to understand and respond to errors effectively.                                                  |
|       | Should                                                                                                                                                           |
| LP-05 | Error messages should be categorized at appropriate levels (info, warning, error).                                                                               |
